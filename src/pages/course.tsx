...
export default function CoursePage() {
  ...
  const iconClass = "absolute left-3 top-[14px] text-gray-400";
          ...
          <div className="mb-8 flex flex-col md:flex-row gap-4 items-center">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-400 focus:outline-none bg-white/50 backdrop-blur-sm"
                value={searchTerm}
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex items-center gap-2 px-4 py-3 bg-white text-gray-700 rounded-xl hover:bg-gray-50 transition-colors border border-gray-200"
              >
                <Filter size={20} />
                Filters
              </button>
            ...
            {showFilters && (
              ...
              >
                <select
                  ...
                  className="p-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-400 focus:outline-none bg-white/50 backdrop-blur-sm"
                >
          ...
          <AnimatePresence>
            {role === 'admin' && showAddForm && (
              <motion.div
                ...
                animate={{ height: 'auto', opacity: 1 }}
                exit={{ height: 0, opacity: 0 }}
                className="mb-10 bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-gray-100 overflow-hidden"
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-4">
                    <button
                      ...
                      className="flex-1 bg-orange-500 hover:bg-orange-600 text-white py-3 px-6 rounded-xl font-semibold transition duration-300"
                    >
                      Create Course
                    </button>
                    <button
                      onClick={handleCancel}
                      className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 py-3 px-6 rounded-xl font-semibold transition duration-300"
                    >
                      Cancel
                    </button>
                  </div>
